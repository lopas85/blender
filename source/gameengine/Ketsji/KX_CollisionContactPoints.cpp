...
static unsigned int kx_collision_contact_point_list_get_sensors_size_cb(EXP_PyObjectPlus *self_v)
{
	return ((KX_CollisionContactPointList *)self_v)->GetNumCollisionContactPoint();
}

static PyObject *kx_collision_contact_point_list_get_sensors_item_cb(EXP_PyObjectPlus *self_v, unsigned int index)
{
...
KX_CollisionContactPointList::KX_CollisionContactPointList(const PHY_ICollData *collData, bool firstObject)
	:
#ifdef WITH_PYTHON
	EXP_BaseListWrapper(this, nullptr, kx_collision_contact_point_list_get_sensors_size_cb,
